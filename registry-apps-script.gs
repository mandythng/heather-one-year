...
const STARTER_GIFTS = [
  ...
  ['pikler-triangle', 'Pikler Triangle', 'A climbing frame for gross motor play at home.', 220, 220, '', 'assets/registry/gift-pikler-triangle.png', 'claim_or_contribute', 2, true],
